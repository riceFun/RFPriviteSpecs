#
#  Be sure to run `pod spec lint KJLHomeshowFront.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "KJLHomeshowFront"
  spec.version      = "0.0.3"
  spec.summary      = "KJLHomeshowFront.framework is powerful SDK for showing home detail for 用户端"
  ...
  spec.description  = <<-DESC
   Dynamic framework,and only for iphone devices
                   DESC
  ...
  spec.vendored_frameworks = "KJLHomeshowFront.framework"
